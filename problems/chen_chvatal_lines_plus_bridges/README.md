...
## Status
Oracle **verified** against Lemma 3.1 (RUN). Full enumeration n=4..9 finds
exactly **12** pendant-free bad graphs (orders 4,5,6,8), matching `|F_0|=12`;
none beyond F_0, none at n=7 or n=9. See `docs/STATUS.md`.
